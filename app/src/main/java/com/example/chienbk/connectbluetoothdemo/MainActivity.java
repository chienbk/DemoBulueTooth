package com.example.chienbk.connectbluetoothdemo;
...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBtAdapter == null) {
            showMessenger("Bluetooth is not available");
            finish();
            return;
        }
    ...
    /**
     * The method used to init the controls
     */
    ...
    /**
     * The method use to show the messenger to the screen
     * @param s
     */
    private void showMessenger(String s) {
    ...
    private final BroadcastReceiver UARTStatusChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothService.DEVICE_DOES_NOT_SUPPORT_UART)){
                showMessenger("Device doesn't support UART. Disconnecting");
                mService.disconnect();
            }
    ...
    public void onBackPressed() {
        if (mState == UART_PROFILE_CONNECTED) {
            ...
            showMessenger("nRFUART's running in background.\n             Disconnect to exit");
        }
        else {
